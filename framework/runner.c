...
struct CONFIG _3dprinter_config = 
{
    ...
    .rams = {
                ...
                { "text", 0x8014000, 0x3000, false, "/home/w/hd/iofuzzer/xxfuzzer/framework/bin/uEmu.3Dprinter.bin", 0x14000, 0x3000 },
                [3 ... 254] = {  NULL, 0, 0, false, NULL, 0, 0  }
    },
    .roms = {
                { "rom", 0x8000000, 0x14000, "/home/w/hd/iofuzzer/xxfuzzer/framework/bin/uEmu.3Dprinter.bin", 0, 0x14000},
