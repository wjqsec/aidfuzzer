...
g++ -I$HEADER_DIR $FUZZER_SRC_DIR/iofuzzer.cpp $FUZZER_SRC_DIR/stream_loader.cpp $FUZZER_SRC_DIR/mutator.cpp $FUZZER_SRC_DIR/stream.cpp -Wno-unused-result -Wno-format -O3 `pkg-config --cflags --libs glib-2.0` -lpthread -lrt -fPIE -o $OUTPUT_DIR/iofuzz
