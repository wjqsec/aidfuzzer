...
//     load_file_rom("/home/w/hd/iofuzzer/xxfuzzer/framework/bin/uEmu.3Dprinter.bin",0x8000000,0,0x14000);
//     load_file_ram("/home/w/hd/iofuzzer/xxfuzzer/framework/bin/uEmu.3Dprinter.bin",0x8014000,0x14000,0x3000);
