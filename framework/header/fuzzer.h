...
//#define ROUND_ROBIN
#define IRQ_STREAM_ID 0x49525100
#define ROUNDROBIN_IRQ_BBLS 1000

#define NUM_IRQ_MEM_ACCESS_TIMES 10
#define NUM_IRQ_CPIE_TIMES 32
#define NUM_IRQ_LOOP_TIMES 7

#define MAX_NOMMIO_BBL_EXEC 15000
#define MAX_MMIO_TIMES 50000
#define MAX_INFINITE_LOOP_EXEC 300
#define MAX_FUZZWARE_MODEL 200
#define MAX_CRASH_SAVE 20
